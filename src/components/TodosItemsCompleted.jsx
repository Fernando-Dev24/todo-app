...
export const TodosItemsCompleted = () => {
   /* contexts variables */
   ...
   /* useEffect to get the active todos and push them to activeTasks state */
   useEffect(() => {
      setCompletedTasks(todoTasks.filter((todo) => todo.state === 'completed'));
   }, [todoTasks]);
